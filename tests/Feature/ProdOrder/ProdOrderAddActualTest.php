...
class ProdOrderAddActualTest extends TestCase
{
    ...
    public function test_add_actual_materials($quantity): void
    {
        ...
        $lackQuantity = $this->prodOrderService->updateMaterials($firstStep, $anotherProduct->id, $quantity);
    ...
    public function test_change_actual_custom1(): void
    {
        ...
        $lackQuantity = $this->prodOrderService->updateMaterialsExact(
            $firstStep,
            $anotherProduct->id,
            $quantity = 110
        );
    ...
    public function test_change_actual_materials($quantity): void
    {
        ...
        $lackQuantity = $this->prodOrderService->updateMaterials($firstStep, $this->rawMaterial->id, $quantity);
        $this->assertEquals(
            match ($quantity) {
                1 => 0,
                6 => 1,

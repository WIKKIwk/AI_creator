...
class StepMaterial extends Component implements HasForms, HasTable
{
    ...
    public function onChangeAvailable(array $data, self $livewire): void
    {
        ...
        try {
            ...
            if (!empty($insufficientAssets)) {
                ...
                $prodOrderService->updateMaterialAvailableExact(
                    $this->step,
                    $data['product_id'],
                    $data['available_quantity']
                );
    ...
    {
        return view('livewire.prod-order.step-material');
    }
}
